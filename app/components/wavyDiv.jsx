...
export default function WavyBorderBox() {
    return (
        <>
        <div id="about" className="relative  bg-[url('/wave.svg')] bg- h-[30px]  bg-contain animate-backgroundPosition">
      ...
      <div className="min-h-screen  bg-[#255C3B] flex items-center justify-evenly pt-44 pb-28 px-10  gap-x-16 text-white">
        <div className="px-10">
          ...
          <h1 className={`${calistoga.className} text-5xl leading-15`}>Helping with Incorporation <br></br>and <span className="text-[#54d186]">ROC Companies</span></h1>
          <p className="text-lg mt-6 mb-12">Providing Consultancy services in the matters of Companies Act, 2013, SEBI Act, 1992, IPR Laws and many other Commercial and Economic Laws.</p>
          </div>
          <div>
